Feature: Ensuring that the page steps work
    ...
    Scenario Outline: 1. Drag and drop selectors by name work
    ...
    Scenario Outline: 2. Drag and drop selectors by id work
        Given I visit the salad test url "browser/mouse.html"
         When I look around
    ...
    Scenario Outline: 3. Drag and drop selectors by css work
        Given I visit the salad test url "browser/mouse.html"
         When I look around
     ...
     Scenario Outline: 4. Drag and drop to a non-target by name
        Given I visit the salad test url "browser/mouse.html"
         When I look around
         Then I should see the element named "drag_handler_name"
    ...
    Scenario Outline: 5. Drag and drop to a non-target with first/last
        Given I visit the salad test url "browser/mouse.html"
         When I look around
     ...
     Scenario Outline: 6. Drag and drop to a non-target with ordinals
        Given I visit the salad test url "browser/mouse.html"
         When I look around

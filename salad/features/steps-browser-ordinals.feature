...
# Select Generator
#    Scenario: Selecting works.
#        Given I visit the salad test url "browser/form.html"
#        When I select the option named "option 3" from the field with id "nr_select_1"
#        Then I should see "Selected 3 in Selector 1!" somewhere in the page
#
#    Scenario Outline: Selecting works.
#        Given I visit the salad test url "browser/form.html"
#        When I select the option named "option 2" from the <ordinal> field named "nr_select_name"
